...
class _AddInventoryState extends State<AddInventory> {
  ...
  Future<void> loadData() async {
    availablePositions = await InventoryPosition.getAvailablePositions(context);
    final machineData = await InventoryPosition.getMachines(context);
    machines = machineData.map((map) => Machines.fromMap(map)).toList();
    setState(() {});
  }
